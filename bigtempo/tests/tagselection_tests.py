...
class TestTagManager_registrations(unittest.TestCase):
    ...
    def test_register_should_not_register_new_mapping_if_no_selection_is_given(self):
        ...
        assert len(self.manager._mappings) == 0
...
class TestTagSelection(unittest.TestCase):
    ...
    def test_initial_selection_should_be_empty(self):
        assert len(self.tagSelection._selection) == 0
    ...
    def test_selection_length(self):
        self.tagSelection._initial_selection = set('abcdefghij')
        assert len(self.tagSelection) == 10
...
class TestTagSelector(unittest.TestCase):
    ...
    def test_get_should_instantiate_new_tag_selection_and_initiate_it(self):
        ...
        when(tagSelectionMock).union(anyx()).thenReturn(tagSelectionMock)
